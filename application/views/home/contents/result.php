				...
				<div class="card-body">
					<ul class="list-group">
						<?php if ($getJawaban != null) : ?>
							<?php for ($i = 0; $i < count($getJawaban); $i++) : ?>
								<?php if ($getJawaban[$i] != null) : ?>
									<li class="list-group-item"><?= $getJawaban[$i]['kode_gejala'] . " - " . $getJawaban[$i]['gejala']  ?> - <b>Ya</b></li>
								<?php else : ?>
						...
						<?php foreach ($getFalseGejala as $falseGejala) : ?>
							<li class="list-group-item"><?= $falseGejala['kode_gejala'] . " - " . $falseGejala['gejala']  ?> - <b>Tidak</b></li>
						<?php endforeach; ?>
					</ul>
				</div>
			</div>
